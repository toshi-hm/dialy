...
- **主要操作**: ドラッグで前日/翌日に移動（連続回転で高速移動）
- **補助操作**: クリック/タップでカレンダーダイアログ表示（MVPでは任意）
...
2. **カレンダー表示**: カレンダーダイアログを表示
3. **日付選択**: 任意の日付を選択（未来日付は不可）
4. **日付確定**: 選択した日付を反映
